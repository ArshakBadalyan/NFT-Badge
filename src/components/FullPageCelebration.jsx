      ...
      <div className="flex flex-col items-center gap-6 p-4 md:gap-6 md:mt-10">
        <div className="flex flex-col items-center gap-4 md:mb-10">
          ...
          <img
            ...
            alt="Badge"
            className="max-w-[150px] sm:max-w-[250px] md:max-w-[350px] lg:max-w-[500px] mb-4"
          />
        </div>

        <div className="flex flex-col content-center items-center gap-2">
          <h2 className="font-bold text-[1.5rem] sm:text-[2rem] md:text-[3rem] text-[#291911] text-center">
            {CONSTANTS.CORPORAL}
          </h2>
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col items-center text-center">
              <h2 className="text-base md:text-lg text-[#35241C] font-inter text-[1.25rem] font-bold">
                {CONSTANTS.EARN_BADGE}
              </h2>
              <h2 className="text-base md:text-lg text-[#DCC794] font-inter text-[1rem] font-normal">
                {CONSTANTS.CLAIM}
                <strong className="text-[#FFF4C0]">
                  {CONSTANTS.NFT_BADGE}
                </strong>
                {CONSTANTS.INVENTORY}
              </h2>
            ...
            <div className="flex flex-col items-center text-center">
              <p className="text-xs md:text-sm text-[#DCC794] text-[0.9rem] font-normal leading-[1rem] text-center">
                {CONSTANTS.EXCHANGE_BADGE}
              </p>
              <p className="text-xs md:text-sm text-[#DCC794] text-[0.9rem] font-normal leading-[1rem] text-center">
                {CONSTANTS.INSUFFICIENT_BADGE}
              </p>
            </div>
          </div>
        </div>
