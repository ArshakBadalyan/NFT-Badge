...
const CompactCelebration = ({ showModal, setShowModal }) => {
  ...
  return (
    <Modal showModal={showModal} image={'bg-[url("/images/modal_background.svg")] bg-cover bg-no-repeat bg-fixed bg-origin-border bg-center'}>
      <div className='flex flex-col items-center p-4 md:p-6'>
        ...
        <div className="relative flex flex-col items-center">
          ...
          <div className="flex flex-col items-center mt-4">
            <p className="text-base sm:text-lg text-center text-[#C8AA7A]">{CONSTANTS.MODAL_DESCRIPTION}</p>  
            <p className="text-base sm:text-lg text-center text-[#C8AA7A]">{CONSTANTS.MODAL_GAINED}</p>  
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center sm:gap-3 md:gap-5 mt-4">
            ...
            />
            <p className="mt-2 md:mt-0 font-semibold text-lg">{CONSTANTS.REWARDS}</p> 
            <Image
